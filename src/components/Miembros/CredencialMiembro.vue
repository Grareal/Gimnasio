<template>
    <div id="credencial">
        <div class="credencial">
            <div class="nav">
                <div>
                    <img width="60" height="40" :src="urlImagen(logoGimnasio)" alt="">
                </div>
                <div>
                    <b> {{ nombreGimnasio }}</b>
            ...
            <p>Miembro desde: <b>{{ miembro.fechaRegistro }}</b></p> <br>
...
export default {
    ...
    data:()=>({
        ...
        .credencial {
            ...
            text-align: center;
            float: left;
            background-image: linear-gradient(50deg, #F26D26 23.53%, #F28326 23.53%, #E2873A 50%, #E29B3A 50%, #E29B3A 73.53%, #E29B3A 73.53%, #cbe0f2 100%);
